...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        [SerializeField] private VRInteractiveItem m_VRInteractiveItem;       // Reference to the VRInteractiveItem to determine when to fill the bar.
		[SerializeField] private MouseInteractiveItem m_MouseInteractiveItem; // Reference to the MouseInteractiveItem to determine when to fill the bar.
        ...
        private void OnEnable ()
        {
			...
			if (m_MouseInteractiveItem) {
				m_MouseInteractiveItem.OnOver += HandleOver;
				m_MouseInteractiveItem.OnOut += HandleOut;
			}
        }
