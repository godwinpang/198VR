...
namespace VRStandardAssets.Utils
{
    ...
    public class UITint : MonoBehaviour
    {
		...
		[SerializeField] private MouseInteractiveItem m_MouseInteractiveItem;	// Reference to the MouseInteractiveItem which must be hovered over to tint the images.
