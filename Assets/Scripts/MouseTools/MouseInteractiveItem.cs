...
// mimics UnityVRAssets' VRInteractiveItem.cs (UnityVRAssets > VRStandardAssets > Scripts)
// so the mouse can be used in the editor in place of gaze controls
public class MouseInteractiveItem : MonoBehaviour {
        ...
        // The below functions are called by the MouseRaycaster when the appropriate input is detected.
